...
namespace TeamServer
{
    public partial class frmMain : Form
    {
        ...
        public static string server_url             = "placeholder";
        ...
        public void f_init()
        {
            ...
            var inif = new classINI();
            string tempfont = inif.Read("font");

            //setFonts(StringToFont(tempfont));

            alog("UI init done");
            try
            {
                checkFiles(); alog("Checking files");
                //var ini = new classINI(settingspath);
                var ini = new classINI();
                server_url = ini.Read("url"); alog("reading settings");
                getUserlist(); alog("loading users from database");
                this.Text += " - connected to server on : " + server_url;
            }
            catch{ MessageBox.Show("No settings set, please enter your server url now."); frmServerurl ss = new frmServerurl();
                ss.ShowDialog();
            }
        ...
        private void ZweitesFensterToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        public void setFonts(Font fonttouse)
        {
